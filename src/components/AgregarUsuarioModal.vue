    ...
    <div class="modal-wrapper">
      <div class="modal-container">
        ...
        <div class="modal-body">
          ...
          <h3 class="subtittle">Suscripcion</h3>
          <div class="container-form">
            <div class="form-flex-column">
              <select name="suscripcion" id="suscripcion" v-model="suscripcion">
                <option disabled value="">Tipo de Suscripcion :</option>
                <option value="mes">Mes</option>
                <option value="anual">Anual</option>
              </select>
              <select name="tipopago" id="tipopago" v-model="tipopago">
            ...
            <div class="form-flex-column">
              <input type="number" placeholder="$" v-model="precio" />
            </div>
          </div>
        </div>
