...
const Report_Products = require("../src/models/Reporte_productos");
const Report_Ventas = require("../src/models/Reporte_ventas");
const Report_Clientes = require("../src/models/Reporte_clientes");
const Report_Proveedores = require("../src/models/Reporte_proveedores");
const Report_Maquinas = require("../src/models/Reporte_maquinas");
...
router.post("/home/products/agregar-producto", (req, res) => {
...
router.post("/home/products/punto-de-venta/:total", (request, response) => {
...
router.post("/home/products/punto-de-venta/update/:id", (request) => {
...
router.post("/home/products/update/existencias", (request) => {
...
router.post("/home/clients", (req, res) => {
  let suscripcion;
...
router.post("/home/clients/:id", (req, res) => {
...
router.post("/home/clients/edit-clients/:id", (request, response) => {
...
router.post("/home/personal", (req, res) => {
...
router.post("/home/personal/edit-personal/:id", (request, response) => {
  const id = request.params.id;
  const data = request.body;
...
router.post("/home/crear-maquina", (request, response) => {
...
router.get("/home/maquina", (request, response) => {
  Maquina.find({})
    .then((data) => {
...
router.get("/home/machine/:id", (request, response) => {
  let id = request.params.id;
...
router.post("/home/machine/:id", (request, response) => {
  const id = request.params.id;
...
router.post("/home/personal/:id", (req, res) => {
  const id = req.params.id;
...
router.post("/home/reports/products", (req, res) => {
...
router.post("/home/reports/ventas", (req, res) => {
...
router.post("/home/reports/proveedores", (req, res) => {
...
router.post("/home/reports/clientes", (request, response) => {
  let suscripcion;
...
router.post("/home/reports/maquinas", (req, res) => {
  //console.log(req.body);
...
//   });
// });
router.post("/home/products/update-all-products", (request, response) => {
...
router.get("/home/products/actualizar-producto", (req, res) => {
  Producto.find({})
    .then((data) => {
...
router.get("/home/products/actualizar-producto/:id", (req, res) => {
...
router.post("/home/products/editar-producto/:id", (request, response) => {
  const id = request.params.id;
  const data = request.body;
...
router.get("/home/clients", (req, res) => {
  Cliente.find({})
    .then((data) => {
      return res.send(data);
    })
...
router.get("/home/clients/:id", (req, res) => {
...
router.get("/home/personal/:id", (req, res) => {
...
router.get("/home/reports/:type", (req, res) => {
...
router.post("/home/products/actualizar-producto/:id", (req, res) => {
